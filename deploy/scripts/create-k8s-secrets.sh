...
AI_STUDY_MAX_TOKENS="${AI_STUDY_MAX_TOKENS:-256000}"
AI_JSON_MODE="${AI_JSON_MODE:-true}"
AI_DOC_MAX_CHARS="${AI_DOC_MAX_CHARS:-5000}"
AI_TOTAL_MAX_CHARS="${AI_TOTAL_MAX_CHARS:-40000}"
AI_TEMPERATURE="${AI_TEMPERATURE:-0.7}"
READING_SPEED_CHARS_PER_MIN="${READING_SPEED_CHARS_PER_MIN:-200}"
...
kubectl create secret generic pomelo-secrets \
    ...
    --from-literal=AI_STUDY_MAX_TOKENS="$AI_STUDY_MAX_TOKENS" \
    --from-literal=AI_JSON_MODE="$AI_JSON_MODE" \
    ...
    --from-literal=READING_SPEED_CHARS_PER_MIN="$READING_SPEED_CHARS_PER_MIN" \
    --from-literal=REGISTRATION_ENABLED="$REGISTRATION_ENABLED" \
